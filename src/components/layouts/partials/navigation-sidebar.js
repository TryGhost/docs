    ...
    <>
        <nav className="mr5 miw50">
            ...
            <ul className="ma0 pa0 list mt4 f8">
                <li className="mb4 lh-1-4"><Link to="" className="link midgrey">What is Ghost?</Link></li>
                <li className="mb4 lh-1-4"><Link to="" className="link midgrey">Setting up a site</Link></li>
                <li className="mb7 lh-1-4">
                ...
                <li className="mb4 lh-1-4"><Link to="" className="link midgrey">Community packages</Link></li>
                <li className="mb7 lh-1-4">
                    <ul className="list ma0 pa0 ml6">
                        <li className="mb3 lh-1-4"><Link to="" className="link midgrey">Docker</Link></li>                        
                    </ul>
                </li>
                <li className="mb4 lh-1-4"><Link to="" className="link midgrey">Install locally</Link></li>
                <li className="mb7 lh-1-4">
                    <ul className="list ma0 pa0 ml6">
