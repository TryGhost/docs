            ...
            <div className="bg-integrations-header-image mb10">
                <div className="bg-integrations-header-cover">
                    ...
                    <div className="pa-vw4 tc">
                        ...
                        <label htmlFor="integrationsearch" className="dn">Search</label>
                        <input id="integrationsearch" name="integrationsearch" className="input-reset form-text pa4 pl5 pr5 mt8 w-100 mw-s f6 br-pill ba b--transparent bg-white shadow-2" type="text" placeholder="Search integrations..." autoComplete="off" />
                    </div>
                </div>
            </div>
        )
