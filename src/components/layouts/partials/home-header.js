...
class MainBox extends React.Component {
    render() {
        return (
            <Box className="col-12 col-4-ns pa5 pa8-ns pa10-l pt8-l flex flex-column-ns items-start tdn content-stretch" to={ this.props.to } radius="4" elevation="2">
    ...
    render() {
        return (
            <div className="gh-bg-home bb b--whitegrey">
                ...
                <div className={Spirit.page.xl + `pb5 pt12 pa-vw2-ns pb-vw3-ns flex flex-column items-center bt bn-ns b--whitegrey`}>
