...
import { Icon, NavBar } from '../common'
import { Spirit } from '../../styles/spirit-styles'

const MainBox = ({ to, title, color, icon, children }) => (
    <Link className="col-12 col-4-ns pa5 pa8-ns pa10-l pt8-l flex flex-column-ns items-start tdn content-stretch home-main-box-shadow db br4 bg-white" to={ to }>
