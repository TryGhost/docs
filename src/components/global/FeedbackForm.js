...
class FeedbackForm extends React.Component {
    render() {
        const formTarget = `https://teamghost.typeform.com/to/NcHfDI?page=` + this.props.location.href
            ...
            <div className="external-scripts relative mw-content center pa5 pa15-ns pt10-ns bg-white shadow-2 mt5 mt10-ns br4">
                ...
                <div className="mt2 flex items-center justify-between">
                    ...
                    <div className="flex-shrink-0">
                        <a className="typeform-share button mt3 ml7 pa3 pl7 pr7 button-blue white tdn bn whitney f8" href={formTarget} data-mode="popup" data-hide-headers="true" data-hide-footer="true" data-submit-close-delay="5" target="_blank" rel="noopener noreferrer">Send Feedback</a>
