    ...
    <Layout title="Home" headerDividerStyle="shadow">
        ...
        <div className={ Spirit.page.l }>
            <section className="grid gutter-2">
                <h3 className={ Spirit.h4 + `col-12 mb2` }>Setup</h3>
                <div className="col-4">
                    <Link to="/setup/" className="link midgrey"><div className="shadow-2 bg-white br4 pa4 pt20 pb20 tc box-hover-test">
                        <h4 className={ Spirit.h5 + `lightgrey`}>Getting Started</h4>
                    </div></Link>
                </div>
                <div className="col-4">
                    <Link to="/concepts/introduction/" className="link midgrey"><div className="shadow-2 bg-white br4 pa4 pt20 pb20 tc box-hover-test">
                        <h4 className={ Spirit.h5 + `lightgrey` }>Core Concepts</h4>
                    </div></Link>
                </div>
                <div className="col-4">
                    <Link to="/tutorials/" className="link midgrey"><div className="shadow-2 bg-white br4 pa4 pt20 pb20 tc box-hover-test">
                        <h4 className={ Spirit.h5 + `lightgrey` }>Tutorials</h4>
                    </div></Link>
                </div>
            </section>
