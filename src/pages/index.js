                    ...
                    <div className="pt-vw3 home-main-box-padding-ns">
                        ...
                        <section className={ Spirit.page.xl + `col-12 mt8 mt-vw3-ns bt bn-ns b--whitegrey pt5 pt0-ns` }>
                            ...
                            <div className="grid-integrations-index mt4 mt6-l f8">
                                <Box to="/integrations/zapier/" className="br4 flex flex-column justify-between items-center middarkgrey pa2 pt5 pb5 tdn tc" elevation="2">
                                    ...
                                    Zapier</Box>
                                <Box to="/integrations/disqus/" className="br4 flex flex-column justify-between items-center middarkgrey pa2 pt5 pb5 tdn tc" elevation="2">
                                    ...
                                    Disqus</Box>
                                <Box to="/integrations/slack/" className="br4 flex flex-column justify-between items-center middarkgrey pa2 pt5 pb5 tdn tc" elevation="2">
                                    ...
                                    Slack</Box>
                                <Box to="/integrations/unsplash/" className="br4 flex flex-column justify-between items-center middarkgrey pa2 pt5 pb5 tdn tc" elevation="2">
                                    ...
                                    Unsplash</Box>
                                <Box to="/integrations/google-analytics/" className="br4 flex flex-column justify-between items-center middarkgrey pa2 pt5 pb5 tdn tc" elevation="2">
                                ...
                                <Box to="/integrations/mailchimp/" className="br4 flex flex-column justify-between items-center middarkgrey pa2 pt5 pb5 tdn tc" elevation="2">
                                    ...
                                    Mailchimp</Box>
                                <Box to="/integrations/google-amp/" className="flex br4 flex-column justify-between items-center middarkgrey pa2 pt5 pb5 tdn tc" elevation="2">
                                    ...
                                    Google AMP</Box>
                                <Box to="/integrations/" className="br4 flex flex-column justify-between items-center middarkgrey pa2 pt5 pb5 tdn" elevation="2">
