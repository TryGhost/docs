    ...
    <Layout title="Home" headerDividerStyle="shadow">
        <div className="center mw-l">
            ...
            <div className="bg-white br4 shadow-1 pa15 pt12 pb12">
                <div>
                    <h2 className={ Spirit.h2 }>Page Templates</h2>
                    <div className="grid">
                        <ul className="col-6 flex-auto list lh-2-0">
                            <li><h3 className={ Spirit.h3 + ` mb2` }>Section landing pages</h3></li>
                        ...
                        <ul className="col-6 flex-auto list lh-2-0">
                            <li><h3 className={ Spirit.h3 + `mb2` }>Posts</h3></li>
                    ...
                    <h2 className={ Spirit.h2 + `mt14` }>Typography</h2>
                    ...
                    <h2 className={ Spirit.h2 + `mt14` }>Components</h2>
                    <div className="grid">
                        <ul className="col-6 list lh-2-0 w-50">
                            <li><h3 className={ Spirit.h3 + `mb2` }>Headers</h3></li>
                        ...
                        <ul className="col-6 list lh-2-0 w-50">
                            <li><h3 className={ Spirit.h3 + `mb2` }>Boxes</h3></li>
                        ...
                        <ul className="col-6 list lh-2-0 w-50">
                            <li><h3 className={ Spirit.h3 + `mb2` }>Navigation</h3></li>
