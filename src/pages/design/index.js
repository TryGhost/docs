    ...
    <Layout title="Home" headerDividerStyle="shadow">
        <div className="center mw-l">
            <div className="pa20 pb30 tc">
                <h1 className={ SpiritStyles.sectionHeading }>Docs Design System</h1>
                <h2 className={ SpiritStyles.sectionSubHeading }>Design stuff for the new docs</h2>
            </div>
            <div className="bg-white br4 shadow-1 pa15 pt12 pb12">
                <div>
                    <h2 className={ SpiritStyles.h2 + `bb b--whitegrey pb2` }>Page Templates</h2>
                    <div className="grid">
                        <ul className="col-6 flex-auto list lh-2-0">
                            <li><h3 className={ SpiritStyles.h3 + `mt2 mb2` }>Section landing pages</h3></li>
                        ...
                        <ul className="col-6 flex-auto list lh-2-0">
                            <li><h3 className={ SpiritStyles.h3 + `mt2 mb2` }>Posts</h3></li>
                    ...
                    <h2 className={ SpiritStyles.h2 + `bb b--whitegrey pb2 mt14` }>Typography</h2>
                    ...
                    <h2 className={ SpiritStyles.h2 + `bb b--whitegrey pb2 mt14` }>Components</h2>
                    <div className="grid">
                        <ul className="col-6 list lh-2-0 w-50">
                            <li><h3 className={ SpiritStyles.h3 + `mt2 mb2` }>Headers</h3></li>
                        ...
                        <ul className="col-6 list lh-2-0 w-50">
                            <li><h3 className={ SpiritStyles.h3 + `mt2 mb2` }>Boxes</h3></li>
                        ...
                        <ul className="col-6 list lh-2-0 w-50">
                            <li><h3 className={ SpiritStyles.h3 + `mt2 mb2` }>Navigation</h3></li>
