...
If running the front-end of your site and Ghost admin on the same domain, remember that there are certain permissions escalation vectors which are unavoidable.
